...
#
# Generated by export_simulation on Thu Nov 04 15:17:53 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './tb_ram.sh' script.
...
./tb_ram.sh -noclean_files

For more information on the script, please type './tb_ram.sh -help'.
