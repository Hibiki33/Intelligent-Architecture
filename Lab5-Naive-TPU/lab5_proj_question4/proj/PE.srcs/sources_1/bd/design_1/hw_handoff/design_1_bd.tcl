...
proc create_root_design { parentCell } {
  ...
  # Create instance: BRAM_FM64, and set properties
  set BRAM_FM64 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BRAM_FM64 ]
  set_property -dict [ list \
   CONFIG.Assume_Synchronous_Clk {true} \
   CONFIG.Byte_Size {8} \
   CONFIG.EN_SAFETY_CKT {false} \
  ...
  # Create instance: BRAM_WM128, and set properties
  set BRAM_WM128 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BRAM_WM128 ]
  set_property -dict [ list \
   CONFIG.Assume_Synchronous_Clk {true} \
   CONFIG.Byte_Size {8} \
   CONFIG.EN_SAFETY_CKT {false} \
  ...
  # Create instance: axi_bram_ctrl_BRAM_FM64, and set properties
  set axi_bram_ctrl_BRAM_FM64 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_BRAM_FM64 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {64} \
   CONFIG.ECC_TYPE {0} \
   CONFIG.PROTOCOL {AXI4} \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_BRAM_FM64
  ...
  # Create instance: axi_bram_ctrl_BRAM_WM128, and set properties
  set axi_bram_ctrl_BRAM_WM128 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_BRAM_WM128 ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.ECC_TYPE {0} \
   CONFIG.PROTOCOL {AXI4} \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_BRAM_WM128
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins BRAM_FM64/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_BRAM_FM64/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins BRAM_WM128/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_BRAM_WM128/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axi_bram_ctrl_BRAM_FM64/S_AXI] [get_bd_intf_pins smartconnect/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axi_bram_ctrl_BRAM_WM128/S_AXI] [get_bd_intf_pins smartconnect/M01_AXI]
  ...
  connect_bd_net -net BRAM_FM32_doutb [get_bd_pins BRAM_FM64/doutb] [get_bd_pins MM_TOP/BRAM_FM64_rddata]
  connect_bd_net -net BRAM_OUT_doutb [get_bd_pins BRAM_OUT/doutb] [get_bd_pins MM_TOP/BRAM_OUT_rddata]
  connect_bd_net -net BRAM_WM32_doutb [get_bd_pins BRAM_WM128/doutb] [get_bd_pins MM_TOP/BRAM_WM128_rddata]
  ...
  connect_bd_net -net MM_TOP_BRAM_FM32_addr [get_bd_pins BRAM_FM64/addrb] [get_bd_pins MM_TOP/BRAM_FM64_addr]
  connect_bd_net -net MM_TOP_BRAM_FM32_clk [get_bd_pins BRAM_FM64/clkb] [get_bd_pins MM_TOP/BRAM_FM64_clk]
  connect_bd_net -net MM_TOP_BRAM_FM32_en [get_bd_pins BRAM_FM64/enb] [get_bd_pins MM_TOP/BRAM_FM64_en]
  connect_bd_net -net MM_TOP_BRAM_FM32_rst [get_bd_pins BRAM_FM64/rstb] [get_bd_pins MM_TOP/BRAM_FM64_rst]
  connect_bd_net -net MM_TOP_BRAM_FM32_we [get_bd_pins BRAM_FM64/web] [get_bd_pins MM_TOP/BRAM_FM64_we]
  connect_bd_net -net MM_TOP_BRAM_FM32_wrdata [get_bd_pins BRAM_FM64/dinb] [get_bd_pins MM_TOP/BRAM_FM64_wrdata]
  ...
  connect_bd_net -net MM_TOP_BRAM_WM32_addr [get_bd_pins BRAM_WM128/addrb] [get_bd_pins MM_TOP/BRAM_WM128_addr]
  connect_bd_net -net MM_TOP_BRAM_WM32_clk [get_bd_pins BRAM_WM128/clkb] [get_bd_pins MM_TOP/BRAM_WM128_clk]
  connect_bd_net -net MM_TOP_BRAM_WM32_en [get_bd_pins BRAM_WM128/enb] [get_bd_pins MM_TOP/BRAM_WM128_en]
  connect_bd_net -net MM_TOP_BRAM_WM32_rst [get_bd_pins BRAM_WM128/rstb] [get_bd_pins MM_TOP/BRAM_WM128_rst]
  connect_bd_net -net MM_TOP_BRAM_WM32_we [get_bd_pins BRAM_WM128/web] [get_bd_pins MM_TOP/BRAM_WM128_we]
  connect_bd_net -net MM_TOP_BRAM_WM32_wrdata [get_bd_pins BRAM_WM128/dinb] [get_bd_pins MM_TOP/BRAM_WM128_wrdata]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MM_TOP/clk] [get_bd_pins axi_bram_ctrl_BRAM_CTRL/s_axi_aclk] [get_bd_pins axi_bram_ctrl_BRAM_FM64/s_axi_aclk] [get_bd_pins axi_bram_ctrl_BRAM_OUT/s_axi_aclk] [get_bd_pins axi_bram_ctrl_BRAM_WM128/s_axi_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins smartconnect/aclk]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins MM_TOP/arst_n] [get_bd_pins axi_bram_ctrl_BRAM_CTRL/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_BRAM_FM64/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_BRAM_OUT/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_BRAM_WM128/s_axi_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins smartconnect/aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs axi_bram_ctrl_BRAM_FM64/S_AXI/Mem0] -force
  assign_bd_address -offset 0x40020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs axi_bram_ctrl_BRAM_WM128/S_AXI/Mem0] -force
