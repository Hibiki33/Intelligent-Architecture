...
module design_1
  ...
  wire [31:0]BRAM_CTRL_doutb;
  wire [63:0]BRAM_FM32_doutb;
  wire [31:0]BRAM_OUT_doutb;
  wire [127:0]BRAM_WM32_doutb;
  wire [31:0]MM_TOP_BRAM_CTRL_addr;
  wire MM_TOP_BRAM_CTRL_clk;
  wire MM_TOP_BRAM_CTRL_en;
  wire MM_TOP_BRAM_CTRL_rst;
  wire [3:0]MM_TOP_BRAM_CTRL_we;
  wire [31:0]MM_TOP_BRAM_CTRL_wrdata;
  wire [31:0]MM_TOP_BRAM_FM32_addr;
  wire MM_TOP_BRAM_FM32_clk;
  wire MM_TOP_BRAM_FM32_en;
  wire MM_TOP_BRAM_FM32_rst;
  wire [7:0]MM_TOP_BRAM_FM32_we;
  wire [63:0]MM_TOP_BRAM_FM32_wrdata;
  wire [31:0]MM_TOP_BRAM_OUT_addr;
  wire MM_TOP_BRAM_OUT_clk;
  wire MM_TOP_BRAM_OUT_en;
  wire MM_TOP_BRAM_OUT_rst;
  wire [3:0]MM_TOP_BRAM_OUT_we;
  wire [31:0]MM_TOP_BRAM_OUT_wrdata;
  wire [31:0]MM_TOP_BRAM_WM32_addr;
  wire MM_TOP_BRAM_WM32_clk;
  wire MM_TOP_BRAM_WM32_en;
  wire MM_TOP_BRAM_WM32_rst;
  wire [15:0]MM_TOP_BRAM_WM32_we;
  wire [127:0]MM_TOP_BRAM_WM32_wrdata;
  ...
  design_1_axi_bram_ctrl_2_bram_0 BRAM_CTRL
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_2_BRAM_PORTA_ADDR}),
        .addrb(MM_TOP_BRAM_CTRL_addr),
        .clka(axi_bram_ctrl_2_BRAM_PORTA_CLK),
        .clkb(MM_TOP_BRAM_CTRL_clk),
        .dina(axi_bram_ctrl_2_BRAM_PORTA_DIN),
        .dinb(MM_TOP_BRAM_CTRL_wrdata),
        .douta(axi_bram_ctrl_2_BRAM_PORTA_DOUT),
        .doutb(BRAM_CTRL_doutb),
        .ena(axi_bram_ctrl_2_BRAM_PORTA_EN),
        .enb(MM_TOP_BRAM_CTRL_en),
        .rsta(axi_bram_ctrl_2_BRAM_PORTA_RST),
        .rstb(MM_TOP_BRAM_CTRL_rst),
        .wea(axi_bram_ctrl_2_BRAM_PORTA_WE),
        .web(MM_TOP_BRAM_CTRL_we));
  design_1_axi_bram_ctrl_0_bram_0 BRAM_FM64
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(MM_TOP_BRAM_FM32_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(MM_TOP_BRAM_FM32_clk),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(MM_TOP_BRAM_FM32_wrdata),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(BRAM_FM32_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(MM_TOP_BRAM_FM32_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(MM_TOP_BRAM_FM32_rst),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(MM_TOP_BRAM_FM32_we));
  design_1_axi_bram_ctrl_3_bram_0 BRAM_OUT
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_3_BRAM_PORTA_ADDR}),
        .addrb(MM_TOP_BRAM_OUT_addr),
        .clka(axi_bram_ctrl_3_BRAM_PORTA_CLK),
        .clkb(MM_TOP_BRAM_OUT_clk),
        .dina(axi_bram_ctrl_3_BRAM_PORTA_DIN),
        .dinb(MM_TOP_BRAM_OUT_wrdata),
        .douta(axi_bram_ctrl_3_BRAM_PORTA_DOUT),
        .doutb(BRAM_OUT_doutb),
        .ena(axi_bram_ctrl_3_BRAM_PORTA_EN),
        .enb(MM_TOP_BRAM_OUT_en),
        .rsta(axi_bram_ctrl_3_BRAM_PORTA_RST),
        .rstb(MM_TOP_BRAM_OUT_rst),
        .wea(axi_bram_ctrl_3_BRAM_PORTA_WE),
        .web(MM_TOP_BRAM_OUT_we));
  design_1_axi_bram_ctrl_1_bram_0 BRAM_WM128
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(MM_TOP_BRAM_WM32_addr),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(MM_TOP_BRAM_WM32_clk),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(MM_TOP_BRAM_WM32_wrdata),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(BRAM_WM32_doutb),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(MM_TOP_BRAM_WM32_en),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(MM_TOP_BRAM_WM32_rst),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(MM_TOP_BRAM_WM32_we));
  design_1_MM_TOP_0_0 MM_TOP
       (.BRAM_CTRL_addr(MM_TOP_BRAM_CTRL_addr),
        .BRAM_CTRL_clk(MM_TOP_BRAM_CTRL_clk),
        .BRAM_CTRL_en(MM_TOP_BRAM_CTRL_en),
        .BRAM_CTRL_rddata(BRAM_CTRL_doutb),
        .BRAM_CTRL_rst(MM_TOP_BRAM_CTRL_rst),
        .BRAM_CTRL_we(MM_TOP_BRAM_CTRL_we),
        .BRAM_CTRL_wrdata(MM_TOP_BRAM_CTRL_wrdata),
        .BRAM_FM64_addr(MM_TOP_BRAM_FM32_addr),
        .BRAM_FM64_clk(MM_TOP_BRAM_FM32_clk),
        .BRAM_FM64_en(MM_TOP_BRAM_FM32_en),
        .BRAM_FM64_rddata(BRAM_FM32_doutb),
        .BRAM_FM64_rst(MM_TOP_BRAM_FM32_rst),
        .BRAM_FM64_we(MM_TOP_BRAM_FM32_we),
        .BRAM_FM64_wrdata(MM_TOP_BRAM_FM32_wrdata),
        .BRAM_OUT_addr(MM_TOP_BRAM_OUT_addr),
        .BRAM_OUT_clk(MM_TOP_BRAM_OUT_clk),
        .BRAM_OUT_en(MM_TOP_BRAM_OUT_en),
        .BRAM_OUT_rddata(BRAM_OUT_doutb),
        .BRAM_OUT_rst(MM_TOP_BRAM_OUT_rst),
        .BRAM_OUT_we(MM_TOP_BRAM_OUT_we),
        .BRAM_OUT_wrdata(MM_TOP_BRAM_OUT_wrdata),
        .BRAM_WM128_addr(MM_TOP_BRAM_WM32_addr),
        .BRAM_WM128_clk(MM_TOP_BRAM_WM32_clk),
        .BRAM_WM128_en(MM_TOP_BRAM_WM32_en),
        .BRAM_WM128_rddata(BRAM_WM32_doutb),
        .BRAM_WM128_rst(MM_TOP_BRAM_WM32_rst),
        .BRAM_WM128_we(MM_TOP_BRAM_WM32_we),
        .BRAM_WM128_wrdata(MM_TOP_BRAM_WM32_wrdata),
        .arst_n(vio_0_probe_out0),
        .clk(processing_system7_0_FCLK_CLK0));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40060000 32 > design_1 BRAM_CTRL" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_axi_bram_ctrl_1_1 axi_bram_ctrl_BRAM_CTRL
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 64 > design_1 BRAM_FM64" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_axi_bram_ctrl_0_0 axi_bram_ctrl_BRAM_FM64
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40040000 32 > design_1 BRAM_OUT" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_axi_bram_ctrl_1_2 axi_bram_ctrl_BRAM_OUT
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40020000 128 > design_1 BRAM_WM128" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_axi_bram_ctrl_1_0 axi_bram_ctrl_BRAM_WM128
  ...
  (* BMM_INFO_PROCESSOR = "arm > design_1 axi_bram_ctrl_BRAM_FM64 design_1 axi_bram_ctrl_BRAM_WM128 design_1 axi_bram_ctrl_BRAM_OUT design_1 axi_bram_ctrl_BRAM_CTRL" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  design_1_smartconnect_0_1 smartconnect
