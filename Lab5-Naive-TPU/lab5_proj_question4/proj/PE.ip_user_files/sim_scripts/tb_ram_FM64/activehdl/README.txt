...
#
# Generated by export_simulation on Wed Nov 10 23:30:01 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './tb_ram_FM64.sh' script.

./tb_ram_FM64.sh -reset_run
...
./tb_ram_FM64.sh -noclean_files

For more information on the script, please type './tb_ram_FM64.sh -help'.
